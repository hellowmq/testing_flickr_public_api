...
class RadialExpansionDemo extends StatelessWidget {
  ...
  RadialExpansionDemo(this.photoUrl);
  ...
  Widget _buildHero(BuildContext context, String imageUrl, String description) {
    return Container(
      width: kMinRadius * 2.0,
      height: kMinRadius * 2.0,
      child: Hero(
        createRectTween: _createRectTween,
        tag: imageUrl + description,
        child: RadialExpansion(
          maxRadius: kMaxRadius,
          child: Photo(
            photo: imageUrl,
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Row(
          ...
          children: [
            _buildHero(context, this.photoUrl, 'Chair'),
            _buildHero(context, this.photoUrl, 'Binoculars'),
            _buildHero(context, this.photoUrl, 'Beach ball'),
          ],
        ),
      ),
    );
